...
type MoodsCollection = MoodType[]

export const MOODS: MoodsCollection = [
    {
        id: "overjoyed",
        label: "Overjoyed",
        emoji: "🤗",
...
export const getMoodById = (moodId: string): MoodType | null => {
    const mood = MOODS.find(eachMood => eachMood.id === moodId);
